...
export const en = {
  ...
  */
  ...
  'settings.engineFailed': 'could not update the download engine',
  'err.engineBusy': 'pause or finish your downloads first — updating replaces the file they run from',
  ...
  */
  ...
  'auto.pause': 'pause',
  'auto.resume': 'resume',
  'auto.checkNow': 'check now',
  'auto.checked': 'checked',
  'auto.remove': 'stop watching',
  'auto.removeConfirm': 'stop watching this series?',
  'auto.removeConfirmBody': '{title} will no longer be checked, and its history here goes with it. Downloads already on disk are untouched.',
  'auto.pipeline': 'what happens with a new episode',
  'auto.always': 'always first',
  'auto.history': 'what has happened',
  'auto.noRuns': 'nothing yet',
  'auto.step.download': 'download',
  'auto.step.rename': 'rename',
  'auto.step.upload': 'send to a share',
  'auto.step.notify': 'notify in Telegram',
  'auto.run.running': 'running',
  'auto.run.done': 'done',
  'auto.run.failed': 'failed',
  'auto.addTitle': 'watch a series',
  'auto.seriesUrl': 'link to the series',
  'auto.seriesUrlHint': 'the page listing its episodes, not one episode',
  'auto.look': 'look',
  ...
  'auto.replaceTo': 'replace with',
  'auto.addReplacement': 'add a replacement',
  'auto.share': 'share',
  'auto.pickShare': 'pick one',
  'auto.noShares': 'no share is set up yet - add one in Settings',
  'auto.remotePath': 'folder on the share',
  'auto.remotePathHint': 'slashes make folders; the same tokens work here',
  'auto.deleteLocal': 'delete the local copy once it is on the share',
  'auto.notifyHint': 'sends a message when an episode arrives, and when one fails. Set the bot up in Settings.',
