...
export const en = {
  ...
  */
  ...
  'auto.notifyHint': 'sends a message when an episode arrives, and when one fails',
  'auto.preview': 'this would produce',
  'auto.stepEnabled': 'this step is on',
  'auto.shareNew': 'a different share...',
  'auto.shareHost': 'server',
  'auto.shareHostHint': 'the machine name or its address on your network',
  'auto.shareName2': 'share',
  'auto.shareNameHint': 'the shared folder itself, without the server or any path',
  ...
  'auto.testConnection': 'test the connection',
  'auto.botToken': 'bot token',
  'auto.botTokenHint': 'from @BotFather in Telegram: send it /newbot and it replies with one',
  'auto.chatId': 'chat id',
  'auto.chatIdHint': 'write to your bot once, then ask @userinfobot for your id',
  'auto.testMessage': 'send a test message',
  'settings.section.automation': 'watching',
  'settings.shares': 'shares',
  'settings.sharesHint': 'where finished episodes are sent. the same shares appear when you set up an upload step.',
  'settings.addShare': 'add a share',
  'settings.noShares': 'none yet',
  ...
  'settings.logVerboseHint': 'records the engine output too. turn on when reporting a problem.',
  'settings.openLog': 'show the log file',
  'settings.logRow': 'log',
} as const
