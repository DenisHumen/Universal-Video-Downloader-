...
export const ru: Dictionary = {
  ...
  'trim.precise': 'точная резка',
  'trim.fast': 'быстрая резка',
  ...
  'settings.engineUpdated': 'движок загрузки обновлён',
  'settings.engineFailed': 'не удалось обновить движок загрузки',
  'err.engineBusy': 'сначала поставьте загрузки на паузу или дождитесь их конца — обновление заменяет файл, из которого они работают',
  'trim.audioExact': 'звук режется точно и без перекодирования — выбирать нечего',
