...
export const ru: Dictionary = {
  ...
  */
  ...
  'auto.share': 'шара',
  'auto.pickShare': 'выберите',
  'auto.noShares': 'шара ещё не настроена - добавьте её в настройках',
  ...
  'auto.notifyHint': 'присылает сообщение, когда серия пришла, и когда что-то не удалось. Бот настраивается в настройках.',
