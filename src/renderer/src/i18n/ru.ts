...
export const ru: Dictionary = {
  ...
  'shortcuts.watch': 'слежение за сериалами',
  ...
  'cap.watch.title': 'следить за сериалом',
  'cap.watch.body':
    'Вставьте ссылку на сериал один раз. Каждая новая серия скачается сама, как только выйдет, а по желанию переименуется, уедет на шару и придёт уведомлением в Telegram.',
  ...
  */
  ...
  'auto.checkNow': 'проверить сейчас',
  'auto.checked': 'проверено',
  'auto.remove': 'перестать следить',
  'auto.removeConfirm': 'перестать следить за сериалом?',
  'auto.removeConfirmBody': '{title} больше не будет проверяться, и история здесь исчезнет вместе с ним. Уже скачанные файлы останутся на месте.',
  'auto.pipeline': 'что делать с новой серией',
  'auto.always': 'всегда первым',
  'auto.history': 'что происходило',
  'auto.noRuns': 'пока ничего',
  'auto.step.download': 'скачать',
  'auto.step.rename': 'переименовать',
  'auto.step.upload': 'отправить на шару',
  'auto.step.notify': 'уведомить в Telegram',
  'auto.run.running': 'идёт',
  'auto.run.done': 'готово',
  'auto.run.failed': 'не удалось',
  'auto.addTitle': 'следить за сериалом',
  'auto.seriesUrl': 'ссылка на сериал',
  'auto.seriesUrlHint': 'страница со списком серий, а не одна серия',
  'auto.look': 'найти',
  'auto.dub': 'какая озвучка',
  'auto.dubHint': 'у разных озвучек разное число серий, поэтому именно это решает, что считать новым',
  ...
  'auto.replaceTo': 'заменить на',
  'auto.addReplacement': 'добавить замену',
  'auto.share': 'шара',
  'auto.remotePath': 'папка на шаре',
  'auto.remotePathHint': 'слэши создают папки; подстановки работают и здесь',
  'auto.deleteLocal': 'удалять локальную копию после отправки',
  'auto.notifyHint': 'присылает сообщение, когда серия пришла, и когда что-то не удалось',
  'auto.preview': 'получится так',
  'auto.stepEnabled': 'шаг включён',
  'auto.shareNew': 'другая шара...',
  'auto.sharePath': 'путь',
  'auto.sharePathHint':
    'путь целиком, так же как вы написали бы его в адресной строке. папка, которой ещё нет, создастся сама',
  'auto.shareFolder': 'папка',
  'auto.shareRoot': 'корень шары',
  'auto.shareHost': 'сервер',
  ...
  'auto.shareLabelHint': 'как она подписана в списках. необязательно',
  'auto.testConnection': 'проверить подключение',
  'auto.botToken': 'токен бота',
  'auto.botTokenHint': 'у @BotFather в Telegram: отправьте ему /newbot и он пришлёт токен',
  'auto.chatId': 'идентификатор чата',
  'auto.chatIdHint': 'напишите своему боту один раз, затем спросите свой id у @userinfobot',
  'auto.testMessage': 'отправить тестовое сообщение',
  'settings.section.automation': 'слежение',
  'settings.shares': 'шары',
  'settings.sharesHint': 'куда отправляются готовые серии. эти же шары предлагаются при настройке шага отправки.',
  'settings.addShare': 'добавить шару',
  'settings.noShares': 'пока ни одной',
  'settings.telegram': 'уведомления в Telegram',
  'settings.telegramHint': 'тот же бот, что использует шаг уведомления. настраивайте здесь или там, где удобнее.',
  'settings.secretsVolatile': 'в этой системе нет хранилища ключей, поэтому пароли живут до закрытия приложения',
  'settings.background': 'продолжать следить в фоне',
  'settings.backgroundHint': 'закрытие окна не останавливает расписания. без этого закрытие их прекращает.',
  'settings.autostart': 'запускаться вместе с системой',
  'settings.autostartHint': 'чтобы расписание пережило перезагрузку. только для установленного приложения.',
  'settings.logVerbose': 'подробный журнал',
  'settings.logVerboseHint': 'записывает и вывод движка. включайте, когда сообщаете о проблеме.',
  'settings.openLog': 'показать файл журнала',
  'settings.logRow': 'журнал',
}
